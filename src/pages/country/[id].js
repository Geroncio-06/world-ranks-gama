        ...
        <div className={styles.container}>
            ...
            <div className={styles.container_right}>
                ...
                <div className={styles.details_panel}>
                    ...
                    <h4 className={styles.details_panel_headding}>Details</h4>
                    ...
                    <div>
                        ...
                        <div className={styles.details_panel_label_borders}>{country.name} Fronteiras</div>

                        <div className={styles.details_panel_row_borders}>
                            {borders.map(({flag, name}) => (
                        
                            <div className={styles.details_panel_row_borders_country}>
                                <img src={flag} alt={name}></img>

                                <div className={styles.details_panel_row_borders_name}>
                                    {name}
                                </div>
                            </div>
